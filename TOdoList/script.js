document.addEventListener('DOMContentLoaded', function() {
    ...
    taskForm.addEventListener('submit', function(event) {
        ...
        if (editId) {
            ...
            var newTask = { id: Date.now().toString(), name: taskName, category: category, dueDate: dueDate, priority: priority };
            tasks.push(newTask);
        }
    ...
    document.getElementById('short-task-btn').addEventListener('click', sortTasksByDueDate);
});
